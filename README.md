...
$ pip2 install bs4
$ pkg install git
$ git clone https://github.com/James404-cyber/CRACKPRO.git
$ cd CRACKPRO
$ python2 Crackpro.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/CRACKPRO.git ; cd CRACKPRO ; python2 Crackpro.py
```
